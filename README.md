...
The code to produce the reports is ```bash chi_ed/reports/render.sh```⁠, this is a sample product and the sample will be incorporated in our ```__main__.py``` module.
---
