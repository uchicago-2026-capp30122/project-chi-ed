...
def plot_bar_graph(
    ...
    for variable, varname in variables.items():
        ...
        data["highlight"] = data["school_name"].apply(
            assign_highlight,
            s1=school1,
            s2=school2,
            s1_label=school1_label,
            s2_label=school2_label,
    ...
    if filepath is not None:
        ...
        raise Warning(
            "No filepath provided. Remeber to provide a filepath to save the plot."
        )
