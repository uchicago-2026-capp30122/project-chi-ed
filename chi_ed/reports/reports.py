...
def generate_figure(df: pandas.DataFrame, variables: dict, school1: str, school2: str, filepath: pathlib.Path, year: int = 2025):
    ...
    plot_bar_graph(df, variables, school1, school2, nrows, ncols, year, filepath)
    return str(filepath)
...
def generate_school_address(df: pandas.DataFrame, school: str):
    """Generate a US-style address for the school."""
