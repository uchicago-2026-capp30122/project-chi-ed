...
def matched_schools(api_dict, rc_dict):
        ...
        for matched_school in same_zip_schools[school_x]:
            ...
            if (
                ...
                school_similarity_lookup[school_x].append(
                    (matched_school, jellyfish.jaro_winkler_similarity(clean_school_x, clean_matched_school))
                )

    school_similarity_lookup["EXCEL ENGLEWOOD HS"] = [] # this school was wrongly matched
