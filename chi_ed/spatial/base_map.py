...
from .data import load_neighborhoods, load_schools, get_mappable_schools, get_school_points, CLEAN_DATA_DIR

# neighborhoods = load_neighborhoods()
# school_data = load_schools()


# def make_base_map(year):
...
#     # Focusing on center point of Chicago (found the coordinates online)
#     center_lat = 41.8781
#     center_lon = -87.6298
...
def make_base_map(year, school_data=school_data, neighborhoods=neighborhoods):
    """
    Build a Folium map with neighborhood boundaries and school dots.

    Parameters:
        year: School year to filter schools by.
        school_data: DataFrame of all schools across all years.
    ...
    school_points["sat_school_average"] = school_points["sat_school_average"].replace(0, "N/A")
...
if __name__ == "__main__":
    ...
    base_map.save(CLEAN_DATA_DIR / "chicago_schools_map.html")
